...
WHERE
    OEF_FIELDS.OE_FORMAT_ID = OE_FORMAT_ID ;REPLACE
    AND OEF_FIELDS.ACTION_TYPE_CD = ACTION_TYPE_CD ; REPLACE
    AND OEF_FIELDS.OE_FIELD_ID = OE_FIELD_ID ;REPLACE
    AND OEF_FIELDS.LABEL_TEXT = LABEL_TEXT ;REPLACE
;----------------------------------------------------------

/* THIS CODE WILL RETRIEVE THE VALUES YOU NEED
SELECT DISTINCT
