; M2031 synonym name correction	"
update into order_catalog_synonym ocs
set ocs.mnemonic = "MBS Billing Code - Ambulatory blood pressure recording cont.>24hrs (11607)"
...
where ocs.synonym_id = 154167641

update into code_value cv_oc
set cv_oc.display = "MBS Billing Code - Ambulatory blood pres"
...
where cv_oc.code_set = 200 ; 'order catalog' code set
and cv_oc.code_value = 154167637

update into order_task ot
set ot.task_description = "MBS Billing Code - Ambulatory blood pressure recording cont.>24hrs (11607)"
...
set cv_es.display = "MBS Billing Code - Ambulatory blood pres"
...
where cv_es.code_set = 93 ; 'event set' code set
...
set es.event_set_cd_disp = "MBS Billing Code - Ambulatory blood pres"
