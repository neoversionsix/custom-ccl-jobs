 ...
 *XXX 09/11/2023 Jason W              Pulling GP from the same table as GP View Mpage
                                      encntr_prsnl_reltn was pulling the most recent gp from that
                                      table regardless of the encounter. It needs to pulll the
                                      data from pr
 ************************************************************************/
