...
DETAIL
    ...
    RECORD_STRUCTURE_1->LIST_1[counter].A_DOB = DOB
    RECORD_STRUCTURE_1->LIST_1[counter].A_SEX = SEX
    RECORD_STRUCTURE_1->LIST_1[counter].A_PHONE_NUMBER_TYPE = PHONE_NUMBER_TYPE
    RECORD_STRUCTURE_1->LIST_1[counter].A_PHONE_NUMBER = PHONE_NUMBER
    RECORD_STRUCTURE_1->LIST_1[counter].A_EMAIL_ADDRESS = EMAIL_ADDRESS
    RECORD_STRUCTURE_1->LIST_1[counter].A_ADDRESS_HOME = ADDRESS_HOME
    RECORD_STRUCTURE_1->LIST_1[counter].A_CITY = CITY
    RECORD_STRUCTURE_1->LIST_1[counter].A_STATE = STATE
    RECORD_STRUCTURE_1->LIST_1[counter].A_COUNTRY = COUNTRY
    RECORD_STRUCTURE_1->LIST_1[counter].A_ZIPCODE = ZIPCODE
;
WITH time =10, maxrec = 2
...
FOR (X = 1 TO COUNTER)
    ...
    CALL NEXTLINE(1)
    CALL PRINTLABELEDDATAFIXED("Phone Type: ",RECORD_STRUCTURE_1->LIST_1[X].A_PHONE_NUMBER_TYPE,90)
    CALL NEXTLINE(1)
    CALL PRINTLABELEDDATAFIXED("Phone Number: ",RECORD_STRUCTURE_1->LIST_1[X].A_PHONE_NUMBER,90)
    CALL NEXTLINE(1)
