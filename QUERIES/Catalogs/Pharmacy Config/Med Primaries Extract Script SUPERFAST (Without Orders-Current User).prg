...
/*
This audit will only give you primaries where the current user last edited the primary.
 */
...
;where oc.updt_id = reqinfo->updt_id 	
...
where	oc.catalog_type_cd = 2516	; code value for 'Pharmacy' from code set 6000
	and oc.updt_id = reqinfo->updt_id ;FILTER FOR ONLY CURRENT USER RUNNING THE AUDIT
	and oc.updt_dt_tm > cnvtlookbehind("8, h") ; Updated in the last 8 hours
