...
IF (FACILITY_PARAMETER_TYPE_VAR = "C1")
	SET FACILITY_SELECTION_TYPE_VAR = "NO SELECTION"
ELSEIF (SUBSTRING(1,1,FACILITY_PARAMETER_TYPE_VAR) = "L")
	SET FACILITY_SELECTION_TYPE_VAR = "LIST SELECTION"
	SET FACILITY_OPERATOR_VAR = "IN"
ELSE; PAR is CX, WHERE X IS A NUMBER >1, Usually C9
	SET FACILITY_SELECTION_TYPE_VAR = "ONE SELECTION"
	SET FACILITY_OPERATOR_VAR = "="
ENDIF
IF (FACILITY_SELECTION_TYPE_VAR = "ONE SELECTION")
    IF ($FACILITY = 0.00)
        SET FACILITY_OPERATOR_VAR = "!="
    ENDIF
ENDIF
...
IF (MEDS_PARAMETER_TYPE_VAR = "C1")
	SET MEDS_SELECTION_TYPE_VAR = "NO SELECTION"
ELSEIF (SUBSTRING(1,1,MEDS_PARAMETER_TYPE_VAR) = "L")
...
ENDIF
IF (MEDS_SELECTION_TYPE_VAR = "ONE SELECTION")
    IF ($PRIMARY = 0.00)
        SET MEDS_OPERATOR_VAR = "!="
    ENDIF
ENDIF
