...
prompt
	...
	, "FACILITY SELECTION" = 0.00
	, "Medication Primary Multi Selector" = 0.00

with OUTDEV, START_DATE_TIME, END_DATE_TIME, FACILITY, PRIMARY
...
JOIN O ; ORDERS
    ...
    ; Primary filter
    ;AND O.CATALOG_CD IN
    AND OPERATOR(O.CATALOG_CD, MEDS_OPERATOR_VAR, $PRIMARY)
