...
SELECT DISTINCT INTO $OUTDEV
    ...
    ,   ADMINISTERED = UAR_GET_CODE_DISPLAY(C_E.EVENT_CD);UAR_GET_CODE_DISPLAY(C_E.CATALOG_CD)
...
PLAN C_E;
    ...
    /* Time Filter */
    AND C_E.PERFORMED_DT_TM >= CNVTDATETIME($STA_DATE_TM)
    AND C_E.PERFORMED_DT_TM <= CNVTDATETIME($END_DATE_TM)
